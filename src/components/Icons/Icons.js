// logo icon
export const LogoIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
...
export const LogoIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Instagram"
...
// home icon
export const HomeIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Home"
...
export const HomeIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const HomeIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Home"
...
export const HomeIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Home"
...
// search icon
export const SearchIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Search"
...
export const SearchIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Search"
...
export const SearchIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Tìm kiếm"
...
export const SearchIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Tìm kiếm"
...
export const ExploreIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Explore"
...
export const ExploreIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Explore"
...
export const ExploreIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Khám phá"
...
export const ExploreIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Khám phá"
...
export const ReelsIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Reels"
...
export const ReelsIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Reels"
...
export const ReelsIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Reels"
...
export const ReelsIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Reels"
...
// message
export const MessageIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const MessageIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Messenger"
...
export const MessageIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Messenger"
...
export const MessageIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Messenger"
...
// Notification
export const NotificationIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const NotificationIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Notifications"
...
export const NotificationIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const NotificationIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Thông báo"
...
// Create
export const CreateIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="New post"
...
export const CreateIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="New post"
...
export const CreateIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="New post"
...
export const CreateIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="New post"
...
// button menu
export const MenuBtnWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Cài đặt"
...
export const MenuBtnWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Cài đặt"
...
export const MenuBtnBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Settings"
...
export const MenuBtnBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Settings"
...
export const MoreIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const MoreIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const HeartIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Like"
...
export const HeartIconBlackSetSize = ({ className = "icon", size }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Like"
...
export const HeartIconActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Unlike"
...
export const HeartIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Thích"
...
// Comment
export const CommentIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Comment"
...
export const CommentIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const ShareIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const ShareIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const SaveIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
...
export const SaveIconActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
...
export const SaveIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Save"
...
export const SaveIconBlackActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Remove"
...
export const SaveIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Lưu"
...
export const SaveIconWhiteActive = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Gỡ"
...
export const EmojiIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Emoji"
...
// blue tick
export const BlueTickIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
// số nhiều icon
export const ItemsIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
// mute
export const MuteIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
export const UnMuteIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
...
// play button
export const PlayBtnIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Biểu tượng nút phát"
    color="rgb(255, 255, 255)"
    fill="rgb(255, 255, 255)"
    height="24"
    role="img"
    ...
    width="24"
  >
    <title>Biểu tượng nút phát</title>
...
// music icon
export const MusicIconWhite = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    ...
    width="12"
  >
    <title>Hình ảnh của âm thanh</title>
...
export const SettingsIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Tùy chọn"
...
export const PostIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
...
export const PostIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
...
export const TagedIcon = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
...
export const TagedIconBlack = ({ className = "icon" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    aria-label=""
